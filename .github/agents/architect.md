---
name: architect
description: Use for the `engineering` phase of a project scope. Turns the approved product design (and any upstream UX spec) into a concrete engineering spec — tech stack, architecture, module boundaries, data models, key interfaces — written as dated specs under docs/engineering/. Invoke after the brainstorm phase is approved (and, in design-heavy projects, after the ux phase is approved). Feature scopes use feature-architect instead.
